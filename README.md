<img width="542" height="227" alt="Снимок экрана 2026-08-04 222439" src="https://github.com/user-attachments/assets/32f3c121-3f50-41f4-af90-01955b340b8a" />
...
**Проблема с NAT**
Однако я столкнулся с проблемой, изначально виртуальная машина работала в режиме **NAT**(Network Address Translation), в этом режиме Kali находилась в изолированной локальной сети и не могла видеть другие физические устройства в моём доме.
...
После настройки окружения и получения действительного адреса шлюза, я приступил к сканированию подсети командой **sudo nmap -sn 192.168.0.0/24**, что позволило создать карту активных устройств в сети
![Обнаружение активных хостов в подсети](scan-nmap.png) 
дальше, я проводил точечный анализ каждого участника.
