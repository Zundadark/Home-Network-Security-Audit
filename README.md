...
Сначала я использовал команду **ip r**, чтобы определить адрес шлюза и граница моей подсети.
**Проблема с NAT**
...
и дальнейшему, точечному анализу каждого элемента по отдельности командой **sudo nmap -sV
