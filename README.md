...
После переключения режима, интернет в Kali пропал, причиной тому этому стало ошибочным использованием виртуального адаптера **Radmin VPN**, вместо моего реального **Gigabit Realtek Ethernet** порта, после выбора правильного адаптера, связь восстановилась.
