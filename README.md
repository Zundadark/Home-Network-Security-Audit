...
2. **Брандмауэр Windows решает**, основная ОС успешно защитилась — статус `filtered` на 996 портах доказал, что Firewall успешно маскирует систему и не даёт успешно завершить сканирование.
